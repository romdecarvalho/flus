...
These functions are related to oil properties, gas properties, and brine properties.
...
"""------------------------------ Definition of saturation coditions ------------------------------------"""
...
if MWo == 0:
        ...
        MWo =  MWOil_CM(API,Kw,Rs,SGG)

print('MWo=', MWo)

print('-----------------------------------------------------------------------')

VpOil_cm_i, RhoOil_cm_i, KOil_cm_i = OilElasticProperties_CM(P,T, MWo, API,Kw,Rs,SGG)
print('CM Oil Acoustic Velocity (m/s)=',VpOil_cm_i*ftsToms)
print('CM Oil Density (g/cm3) =',RhoOil_cm_i*lbft3Togcm3)
print('CM Oil Bulk modulus (GPa)=',KOil_cm_i*PsiToGPa)

print('-----------------------------------------------------------------------')

VpOil_bw_i, RhoOil_bw_i, KOil_bw_i = LiveOilElasticProperties_BW(P,T,API, Rs, SGG)
print('BW Oil Acoustic Velocity (m/s)=',VpOil_bw_i*ftsToms)
print('BW Oil density (g/cm3) =',RhoOil_bw_i*lbft3Togcm3)
print('BW Oil Bulk modulus (GPa)=',KOil_bw_i*PsiToGPa)

print('-----------------------------------------------------------------------')

VpGas_cm_i, RhoGas_cm_i, KGas_cm_i = GasElasticProperties_CM(P, T, SGG, gastype=1, yH2S=0,yCO2=0,yN2=0)
print('CM Gas Acoustic Velocity (m/s)=',VpGas_cm_i*ftsToms)
print('CM Gas Density (g/cm3) =',RhoGas_cm_i*lbft3Togcm3)
print('CM Gas Bulk modulus (GPa)=',KGas_cm_i*PsiToGPa)

print('-----------------------------------------------------------------------')

VpGas_bw_i, RhoGas_bw_i, KGas_bw_i = GasElasticProperties_BW(SGG,P,T)
print('BW Gas Acoustic Velocity (m/s)=',VpGas_bw_i*ftsToms)
print('BW Gas Density (g/cm3) =',RhoGas_bw_i*lbft3Togcm3)
print('BW Gas Bulk modulus (GPa)=',KGas_bw_i*PsiToGPa)

print('-----------------------------------------------------------------------')

VpBrine_bw_i, RhoBrine_bw_i, KBrine_bw_i = BrineElasticProperties_BW(P,T,S)
print('BW Brine Acoustic Velocity (m/s)=',VpBrine_bw_i*ftsToms)
print('BW Brine Density (g/cm3) =',RhoBrine_bw_i*lbft3Togcm3)
print('BW Brine Bulk modulus (GPa)=',KBrine_bw_i*PsiToGPa)



print('-----------------------------------------------------------------------')

KFluid_bw_i = KFluid_func(Sw, So, Sg, KBrine_bw_i, KOil_bw_i, KGas_bw_i)
RhoFluid_bw_i = rho_fluid_func(Sw, So, Sg, RhoBrine_bw_i, RhoOil_bw_i, RhoGas_bw_i)

print('K fluid as per BW (GPa)', KFluid_bw_i*PsiToGPa)
print('RHO fluid as per BW (g/cm3)', RhoFluid_bw_i*lbft3Togcm3)

print('-----------------------------------------------------------------------')

KFluid_cm_i = KFluid_func(Sw, So, Sg, KBrine_bw_i, KOil_cm_i, KGas_cm_i)

RhoFluid_cm_i = rho_fluid_func(Sw, So, Sg, RhoBrine_bw_i, RhoOil_cm_i, RhoGas_cm_i)

print('K fluid as per CM (GPa)', KFluid_cm_i*PsiToGPa)
print('RHO fluid as per CM (g/cm3)', RhoFluid_cm_i*lbft3Togcm3)

print('-----------------------------------------------------------------------')

print('% difference KFLUID',np.abs(KFluid_bw_i - KFluid_cm_i)*100/KFluid_bw_i)
print('% difference RHOFLUID',np.abs(RhoFluid_bw_i - RhoFluid_cm_i)*100/RhoFluid_bw_i)
